...
http://www.kernelmode.info/forum/ "information, similar approaches"
http://www.rohitab.com/discuss/topic/42456-system-call-hook-example/?hl=%2Bntquerysysteminformation#entry10104970 "Examples of hooking"
https://github.com/M00nRise/ProcessHider "Hooking and injecting DLL"
https://docs.microsoft.com/en-us/sysinternals/ "Tools for checking windows internals"
http://www.sql.ru/forum/214050/dll-i-konsol "Extra Console"
...
#define NAME_COLUMN_TITLE L"Column name"
#define PID_COLUMN_TITLE L"Pid Column"
#define DESCRIPTION_COLUMN_TITLE L"Description Column"
...
namespace nsNtSetInformationProcess {
	...
	*/
	...
	NTSTATUS hookFunction( // This fuction is called only when i tries to close the app
		IN HANDLE						ProcessHandle,
		IN PROCESS_INFORMATION_CLASS	ProcessInformationClass,
		IN PVOID						ProcessInformation,
		IN ULONG						ProcessInformationLength
